...
namespace CustomerService.Api.Tests.Integration;

public class CustomerServiceApiFactory : WebApplicationFactory<IApiMarker>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _postgreSqlContainer =
        new PostgreSqlBuilder()
            .WithImage("postgres:latest")
            .WithDatabase("CustomerService")
